	...
	<fieldset id="ldapSettings-1">
		<div id="ldapAdvancedAccordion">
			...
			<div>
				...
				<p><label for="ldap_skip_conflicting_objects"><?php p($l->t('Skip conflicting LDAP objects'));?></label><span class="inlinetable"><span class="tablerow left"><input type="checkbox" id="ldap_skip_conflicting_objects" name="ldap_skip_conflicting_objects" value="1" data-default="<?php p($_['ldap_skip_conflicting_objects_default']); ?>" title="<?php p($l->t('Skip LDAP objects (users and groups) already defined in NextCloud, instead of renaming them to avoid name conflict.'));?>" /><span class="tablecell"></span></span>
			</span><br/></p>
			</div>
